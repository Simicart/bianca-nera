...
class Main extends \Magento\Backend\Block\Widget\Form\Generic implements \Magento\Backend\Block\Widget\Tab\TabInterface
{
    ...
    public function _prepareForm()
    {
        ...
        $fieldset->addField('banner_name', 'image', ['name'     => 'banner_name',
            'label'    => __('Image (width:1160px, height:438px)'),
            'title'    => __('Image (width:1160px, height:438px)'),
            'required' => false,
            'disabled' => $isElementDisabled
        ]);
        ...
        $fieldset->addField(
            ...
            'label'    => __('Mobile Image (width:343px, height:161px)'),
            'title'    => __('Mobile Image (width:343px, height:161px)'),
            'required' => false,
            'disabled' => $isElementDisabled
                ]
        );
